...
| T103 | EXPONENTIAL | 0,03 | 2 | | 1.976 líneas / 28 archivos sin `docs/` (2.945 / 40 con la planificación) | 0 | 0 | 4 | 52 (compartidos por T103 a T105; confirmados en Exponential) | 4 |
| T104 | EXPONENTIAL | 0,49 | 2 | | 1.650 líneas / 40 archivos (PR #31, con `docs/`) | 0 | 1 | 4 | ver T103 | 4 |
| T105 | EXPONENTIAL | 0,49 | 1 | | 1.959 líneas / 20 archivos sin `docs/` | 0 | 0 | 4 | ver T103 | 4 |
...
- M5 = 0: aprobado a la primera.
- M7 = 4 (dada por el usuario el 2026-09-24, junto con M7 = 4 y M9 = 4 de T103 y T104). M9 = 4 (dada por el usuario al cerrar el hito).
- M8: el usuario confirmó los 52 minutos de la planificación y la entrada quedó `CONFIRMED` en Exponential el 2026-09-24 (`exponential time confirm --date 2026-09-23`).
