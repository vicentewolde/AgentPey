 ...
 * Normative description: docs/fase-6-agentguard-comercializacion/vitrinee/SPEC-agent-storefront.md (day 3).
 */
import { z } from "zod";
...
export const storefrontManifestSchema = z.strictObject({
  ...
  merchant: z.strictObject({
    name: z.string().min(1),
    /** The merchant's receipt-signing key (VT-8). Verifies receipts; cannot move funds. */
  ...
  fx: z.strictObject({
    ...
    /** No oracle in this version — docs/fase-6-agentguard-comercializacion/vitrinee/DECISIONES.md, VT-2. */
